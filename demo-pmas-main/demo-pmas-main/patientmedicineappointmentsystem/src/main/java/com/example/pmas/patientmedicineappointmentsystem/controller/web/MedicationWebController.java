...
public class MedicationWebController {
     ...
     */
    // http://localhost:8080/web/medications/list
    ...
    // http://localhost:8080/web/medications/view/{id}
     ...
     */
    // http://localhost:8080/web/medications/add-medication
...
//            System.out.println(newMedication.toString());
    ...
    // http://localhost:8080/web/medications/update-medication/{id}
    /**
...
//            System.out.println(prescriptionDate);
    ...
    // http://localhost:8080/web/medications/delete/{id}
    /**
